...
if (isset($_GET['id'])) {
    ...
    // Pega os dados do usuário para editar
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE usuarios SET nome = ?, sobrenome = ?, email = ?, senha = ? WHERE id = ?";
    $stmt = $conn->prepare($sql);
...
<body>
    ...
    <form method="POST">
        ...
        <input type="text" name="sobrenome" value="<?= $user['sobrenome'] ?>" required><br><br>
